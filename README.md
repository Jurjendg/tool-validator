...
The validator writes SQLite tables for extracted XML data, generated `/current` requests, API responses, BENG2/label comparisons, construction-part summaries, and skipped/excluded case counts.
